...
const (
	PingBot_StartScan_FullMethodName  = "/proto.PingBot/StartScan"
	PingBot_SetTimings_FullMethodName = "/proto.PingBot/SetTimings"
)
...
func (c *pingBotClient) StartScan(ctx context.Context, in *PingOptions, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, PingBot_StartScan_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pingBotClient) SetTimings(ctx context.Context, in *Timings, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, PingBot_SetTimings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPingBotServer must be embedded to have
...
func (UnimplementedPingBotServer) testEmbeddedByValue()                 {}
...
func RegisterPingBotServer(s grpc.ServiceRegistrar, srv PingBotServer) {
	// If the following call pancis, it indicates UnimplementedPingBotServer was
...
func _PingBot_StartScan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PingBot_StartScan_FullMethodName,
	}
...
func _PingBot_SetTimings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PingBot_SetTimings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
