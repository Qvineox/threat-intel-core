...
type CoverageStatistics struct {
	...
	PercentOfSavedIPs float32                `protobuf:"fixed32,3,opt,name=PercentOfSavedIPs,proto3" json:"PercentOfSavedIPs,omitempty"` // percentage of scanned IP addresses to total amount of distinct IPs already saved in a system
	PercentOfTotalIPs float32                `protobuf:"fixed32,4,opt,name=PercentOfTotalIPs,proto3" json:"PercentOfTotalIPs,omitempty"` // percentage of scanned IP addresses to total amount of available IPs
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *CoverageStatistics) GetPercentOfSavedIPs() float32 {
	if x != nil {
...
func (x *CoverageStatistics) GetPercentOfTotalIPs() float32 {
	if x != nil {
...
var file_statistics_proto_rawDesc = []byte{
	...
	0x66, 0x53, 0x61, 0x76, 0x65, 0x64, 0x49, 0x50, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x02, 0x52,
	...
	0x6f, 0x74, 0x61, 0x6c, 0x49, 0x50, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x02, 0x52, 0x11, 0x50,
