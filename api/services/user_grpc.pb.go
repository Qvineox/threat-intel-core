...
type UserServiceClient interface {
	GetUsers(ctx context.Context, in *UsersQueryFilter, opts ...grpc.CallOption) (*Users, error)
...
func (c *userServiceClient) GetUsers(ctx context.Context, in *UsersQueryFilter, opts ...grpc.CallOption) (*Users, error) {
...
type UserServiceServer interface {
	GetUsers(context.Context, *UsersQueryFilter) (*Users, error)
...
func (UnimplementedUserServiceServer) GetUsers(context.Context, *UsersQueryFilter) (*Users, error) {
...
func _UserService_GetUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUsers(ctx, req.(*UsersQueryFilter))
	}
